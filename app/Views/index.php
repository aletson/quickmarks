        ...
        <tbody>
          ...
          ?>
                <tr data-mark="<?= $thisMark->id; ?>" data-instance-id="<?= $thisMark->instance; ?>">
                  <td><?php echo $thisMark->name; ?> <?php if (count($thisZone->instances) > 1) echo '<span class="badge badge-pill badge-light">' . $thisMark->instance . '</span>'; ?><?php if (isset($thisMark->nickname)) echo '<small><i><span class="text-faded">&nbsp;' . $thisMark->nickname . '</span></i></small>'; ?></td>
