    ...
    <tbody>
      ...
      ?>
              <tr data-mark="<?= $thisMark->id; ?>" data-instance-id="<?= $thisMark->instance; ?>">
                <td><?php echo $thisMark->name; ?> <?php if ($thisMark->instance > 1) echo '(I' . $thisMark->instance . ')'; ?><br /><small><i>\t<?php if (isset($thisMark->nickname)) echo $thisMark->nickname; ?></i></small></td>
